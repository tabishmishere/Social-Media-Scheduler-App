    ...
    return (
        <section className="relative overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto px-5 sm:px-8 pt-20 pb-12 text-center animate-fade-in-up">
                {/* Badge */}
                <div className="inline-flex items-center gap-2 bg-red-50 border border-red-100 text-red-500 text-sm px-3.5 py-1.5 rounded-full mb-8 animate-float shadow-sm">
                    <span className="size-1.5 bg-red-400 rounded-full animate-ping" />
                ...
                <h1 className="font-serif text-5xl sm:text-6xl md:text-7xl xl:text-8xl text-slate-900 tracking-tight">
                    Schedule smarter.
                    <br />
                    <span className="text-red-500 italic inline-block transition-transform duration-300 hover:scale-105">Grow faster.</span>
                </h1>

                {/* Subheadline */}
                <p className="mt-7 text-gray-500 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">Scheduler lets you create, schedule, and auto-engage across all your social platforms — powered by AI that writes your captions and replies for you.</p>

                {/* CTAs */}
                <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
                    <Link to="/login" className="btn-animate bg-red-500 text-white rounded-full font-medium hover:bg-red-600 shadow-md hover:shadow-red-500/30 inline-flex items-center gap-2 text-[15px] px-8 py-3.5 w-full sm:w-auto justify-center transition-all active:scale-95">
            ...
            <div className="relative max-w-5xl mx-auto px-5 sm:px-8 pb-0 animate-scale-in">
                <div className="rounded-t-2xl overflow-hidden border border-gray-200 border-b-0 shadow-2xl transition-all duration-500 hover:shadow-red-500/10">
                    {/* Browser chrome */}
                    <div className="flex items-center gap-2 px-4 py-3" style={{ background: "#f0f0f0", borderBottom: "1px solid rgba(0,0,0,0.06)" }}>
                        <div className="w-3 h-3 rounded-full bg-red-400 hover:opacity-80 cursor-pointer transition-opacity" />
                        ...
                        <div className="rounded-xl p-4 space-y-3 bg-white border border-slate-100">
                            ...
                            {[
                                ...
                                <div key={item.text} className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 transition-colors cursor-pointer">
                                    <DotIcon className="size-5 text-red-500 animate-pulse" />
